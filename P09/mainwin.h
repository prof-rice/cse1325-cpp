...
const std::string FILE_VERSION = "0.3";   // So we can adapt to file format changes later
...
class Mainwin : public Gtk::Window {
    ...
    protected:
        ...
        void on_new_teacher_click();     // Create a new teacher
        void on_new_course_click();      // Create a new course
        void on_new_section_click();     // Create a new section
        void on_new_transcript_click();  // Create a new transcript
        void on_set_grade_click();       // Change a grade in a transcript
